...
<body class="hold-transition login-page" style="background-image: url('{{ url('img/accounting.jpg') }}');background-repeat: no-repeat;">
<div class="login-box">
...
<script src="{{asset_path('lte/dist/js/adminlte.min.js')}}"></script>
