		...
		<div class="row">
			...
			<div class="col-md-4">
				<div class="form-group">
					<div class="form-line">
						{!! Form::label('numberofrow', 'Number Of User', array('class' => 'col-form-label')) !!}<span class="required"> *</span>
			...
			<div class="col-md-4">
				<div class="form-group">
					<div class="form-line">
						{!! Form::label('username', 'User Name Prefix', array('class' => 'col-form-label')) !!}<span class="required"> *</span>
...
<script>
    ...
    $("#submitButton").click(function () {
        ...
        $.ajax({
            url: "{{url('manage-pin/bulk-pin-create')}}/"+rowNum + "/" + username,
            type: 'GET',
            data: {},
        })
        .done(function (data) {
