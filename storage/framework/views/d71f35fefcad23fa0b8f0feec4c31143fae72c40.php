<script src="<?php echo e(asset_path('lte/plugins/jquery/jquery.min.js')); ?>"></script>
<script src="<?php echo e(asset_path('lte/plugins/bootstrap/js/bootstrap.bundle.min.js')); ?>"></script>
<script src="<?php echo e(asset_path('lte/plugins/overlayScrollbars/js/jquery.overlayScrollbars.min.js')); ?>"></script>
<script src="<?php echo e(asset_path('lte/dist/js/adminlte.js')); ?>"></script>
<script src="<?php echo e(asset_path('lte/dist/js/demo.js')); ?>"></script>
<script src="<?php echo e(asset_path('lte/plugins/chart.js/Chart.min.js')); ?>"></script>

<script src="<?php echo e(asset_path('lte/jquery-confirm/jquery-confirm.min.js')); ?>"></script>

<script src="<?php echo e(asset_path('lte/plugins/select2/js/select2.full.min.js')); ?>"></script>

<script src="<?php echo e(asset_path('lte/wnoty/wnoty.js')); ?>"></script>
...
<script src="<?php echo e(asset_path('lte/bootstrap-datetimepicker/moment.min.js')); ?>"></script>

<script src="<?php echo e(asset_path('lte/bootstrap-datetimepicker/bootstrap-datetimepicker.min.js')); ?>"></script>
...
<script type="text/javascript">
  $(document).ready(function() {
    notify('<?php echo e(session()->get('danger')); ?>','danger');
    playTone('danger');
});
</script>
<?php endif; ?>
...
<script type="text/javascript">
  ...
  function playTone(which) {
      var sound = "<?php echo e(auth()->user()->sound); ?>";
      if(sound == 1){
        var obj = document.createElement("audio");
        obj.src = "<?php echo e(url('public/lte/tones')); ?>/"+(which)+".mp3";
        obj.play();
    }
}
...
<?php /**PATH C:\xampp\htdocs\vpn\resources\views/layouts/js.blade.php ENDPATH**/ ?>